...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_L1] = LAYOUT_all( /* Base */
    ...
    KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N, KC_M, KC_COMM,    KC_DOT,  KC_SLSH,    KC_A,    KC_RSFT, KC_LSFT,
    KC_LCTL, KC_LGUI, KC_LALT,          KC_ENT,           KC_HOME,       KC_END,           KC_INS,  KC_RALT,    KC_RGUI, KC_RIGHT, KC_RCTL
  ),
  [_L2] = LAYOUT_all( 
    QK_BOOT,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,     KC_F10,    KC_F11,     KC_F12,   KC_GRV,  _______,
